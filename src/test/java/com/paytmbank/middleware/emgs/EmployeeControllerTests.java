...
class EmployeeControllerTests {
	...
	void login(JwtRequest user) throws Exception {
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/login").contentType(MediaType.APPLICATION_JSON)
